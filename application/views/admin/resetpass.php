          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                  <form class="user" method="post" action="<?= base_url('admin/resetpass/'.$akun['username']); ?>">
                    ...
                    <a class="btn btn-secondary btn-user btn-block" href="<?= base_url('admin/daftarakun'); ?>">Batal</a>
                  </form>
                </div>
              </div>
            </div>
