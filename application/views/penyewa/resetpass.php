          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                  <form class="user" method="post" action="<?= base_url('penyewa/resetpass/'.$akun['username']); ?>">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Username" value="<?=$akun['username']?>" readonly>
                    </div>
                    <div class="form-group">
                      <input type="hidden" class="form-control form-control-user" id="level" name="level" placeholder="level" value="<?=$akun['level']?>" readonly>
                    </div>
                    ...
                    <a class="btn btn-secondary btn-user btn-block" href="<?= base_url('penyewa/daftarakun'); ?>">Batal</a>
                  </form>
                </div>
              </div>
            </div>
